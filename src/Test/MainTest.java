...
import Screens.ProductReviewPageObject;
...
public class MainTest {
	...
	private String reportPath;
	 ...
	 public void compareTabletPrices(String deviceName) throws Exception  {
		 ...
		 ProductReviewPageObject productReviewObj = new PopUps(driver).checkForPopUp()
				 											.searchAndSelectDevice(deviceName)
				 												.clickReviewTab();
					
		 String reviewRating = productReviewObj.userReviewNumberTextGetText();
		 System.out.println("Rating is :"+reviewRating);			
		 Reporter.log("Rating is :"+reviewRating+"\n");
					
		 String thirdLowestPrice = productReviewObj.clickPricesTab().sortAndSelectThirdLowVal();
